...
import {create_directory} from "@/utils/createNew";
...
export const MainComponent = () => {
    ...
    // const [newItem, setNewItem] = useState<{ type: 'file' | 'dir'; dummyName: string } | null>(null);
    ...
    const handleEntryCreation = (type: 'file' | 'directory') => {
                    ...
                    <ContextMenuContent className={'w-56'}>
                        ...
                        <ContextMenuSub>
                            ...
                            <ContextMenuSubContent className={'w-56'}>
                                ...
                                <ContextMenuItem><Image src={'/main/text.png'} alt={''} width={16}
                                                        height={16}/>File</ContextMenuItem>
                                <ContextMenuItem><Image src={'/main/ms-word.png'} alt={''} width={16} height={16}/>Word
                                    Document</ContextMenuItem>
                                <ContextMenuItem><Image src={'/main/ms-excel.png'} alt={''} width={16} height={16}/>Excel
                                    Document</ContextMenuItem>
                                <ContextMenuItem><Image src={'/main/ms-powerpoint.png'} alt={''} width={16}
                                                        height={16}/>Powerpoint Document</ContextMenuItem>
                            </ContextMenuSubContent>
                        </ContextMenuSub>
                        <ContextMenuItem><Terminal className={'text-white bg-black'}/> Open in
                            Terminal</ContextMenuItem>
                        <ContextMenuItem>
                            <Wrench/> Properties
                        </ContextMenuItem>
                    </ContextMenuContent>
